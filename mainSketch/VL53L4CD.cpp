...
VL53L4CDWrapper::VL53L4CDWrapper(const int addresses[], int addrCount,
                                 const int *tcaChans, TCA9548A &tcaRef)
    : sensorCount(addrCount), tcaChannels(tcaChans),
...
VL53L4CDWrapper::~VL53L4CDWrapper() { delete[] sensors; }
